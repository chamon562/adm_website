...
/* to stack image on top of text when screen is changed */
...
const ColumnLeft = styled.div`
    ...
    line-height: 1.4;
    padding: 1rem 2rem;
    /* a way to rearange the grid to have it on left or right */
...
const ColumnRight = styled.div`
    ...
    justify-content: center;
    align-items:center;
    /* for mobile like to have text first then the image */
    @media screen and (max-width: 768px){
        order: ${({ reverse }) => (reverse ? '2' : '1')};
